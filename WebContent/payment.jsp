...
<link rel="stylesheet" href="<%=path%>/css/tasp.css" />
<link href="<%=path%>/css/orderconfirm.css" rel="stylesheet" />
...
<ul id="address-list" class="address-list">
 ...
 <label for="addrId_674944241" class="user-address">
         河北省 石家庄市裕华区南二环  河北师范大学学院（软件学院）  男生宿舍楼6期4号楼 (someone 收) <em>18362123736</em>
   </label>
 ...
 <label for="addrId_594209677" class="user-address">
       河北省 石家庄市裕华区南二环  河北师范大学学院（软件学院）  男生宿舍楼6期4号楼 (someone 收) <em>18362123736</em></label><em class="tip" style="display: none">默认地址</em>
...
<tr class="shop blue-line">
 <td colspan="3">
   店铺：<a class="J_ShopName J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.6" href="login.jsp"
 target="_blank" title="达文西蛋糕店">达文西蛋糕店</a>
     <span class="seller">卖家：<a href="https://baike.baidu.com/item/%E8%BE%BE%E9%97%BB%E8%A5%BF/5833597?fr=aladdin" target="_blank" class="J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.15">达文西</a></span>
...
<tr class="item" data-lineid="19614514619:31175333266:35612993875" data-pointRate="0">
 <td class="s-title">
   <a href="#" target="_blank" title="您选择的蛋糕" class="J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.5">
     <img src="<%=path%>/${cake.img1}" class="itempic"><span class="title J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.5">${cake.name}</span></a>
...
<img src="http://img03.taobaocdn.com/tps/i3/T1bnR4XEBhXXcQVo..-14-16.png"/>
 ...
 <td class="s-price">
  ...
  <span class='price '>
 <em class="style-normal-small-black J_ItemPrice"  >${cake.price}</em>
  </span>
<input type="hidden" name="costprice" value="630.00" class="J_CostPrice" />
</td>
 <td class="s-amount" data-point-url="">
         <input type="hidden" class="J_Quantity" value="1" name="19614514619_31175333266_35612993875_quantity"/>${cake.num}
 
 </td>
 <td class="s-agio">
       <div class="J_Promotion promotion" data-point-url="">优惠后打折价</div>
   </td>
 <td class="s-total">
   
   <span class='price '>
 <em class="style-normal-bold-red J_ItemTotal "  >${(cake.price)*(cake.num)}</em>
  </span>
    <input id="furniture_service_list_b_47285539868" type="hidden" name="furniture_service_list_b_47285539868"/>
 </td>
</tr>
<c:set var="sum" value="${sum+(cake.price)*(cake.num)}"></c:set>


</c:forEach>


<c:set var="sum1" value="${sum+25}"></c:set>
...
<tr class="shop-total blue-line">
 <td colspan="5">店铺合计(<span class="J_Exclude" style="display: none">不</span>不含含运费<span class="J_ServiceText" style="display: none">，服务费</span>)：
   <span class='price g_price '>
 <span>&yen;</span><em class="style-middle-bold-red J_ShopTotal"  >${sum }</em>
  </span>
...
<div class="J_AddressConfirm address-confirm">
 ...
 <span>&yen;</span><em class="style-large-bold-red"  id="J_ActualFee"  >${sum1 }</em>
  </span>
</div>

  <ul >
 <li><em>寄送至:</em><span id="J_AddrConfirm" style="word-break: break-all;">
    河北省 石家庄市裕华区南二环  河北师范大学学院（软件学院）  男生宿舍楼6期4号楼 
   </span></li>
 <li><em>收货人:</em><span id="J_AddrNameConfirm">某某某 18124315656 </span></li>
 </ul>
     </div>
 </div>
         <a href="<%=path%>/tocart.action/tomycart"
 class="back J_MakePoint" target="_top"
 data-point-url="">返回购物车</a>
       <a href="<%=path%>/success.jsp" id="J_Go" class=" btn-go"  data-point-url=""  tabindex="0" title="点击此按钮，提交订单。">提交订单<b class="dpl-button"></b></a>
  </div>
 </div>
...
<p>Copyright &copy; 2017<a target="_blank" href="https://baike.baidu.com/item/%E8%BE%BE%E9%97%BB%E8%A5%BF/5833597?fr=aladdin">文西蛋糕店</a></p>
</div>
</body>
</html>
